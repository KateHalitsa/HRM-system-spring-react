...
export const PageAccess: PageRoles[] = [
    ...
    new PageRoles('/project', [ROLE.HR_OFFICER, ROLE.HR_MANAGER]),
    new PageRoles('/employee_workplace', [ROLE.HR_OFFICER, ROLE.DIRECTOR]),
    new PageRoles('/analysis', [ROLE.HR_OFFICER, ROLE.DIRECTOR]),
]
